...
@str1.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str2.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str3.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str4.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str5.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str6.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str7.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str8.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str9.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str10.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str11.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str12.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str13.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str14.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str15.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str16.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str17.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str18.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str19.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str20.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str21.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str22.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str23.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str24.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str25.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str26.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str27.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str28.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str29.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
@str30.on(events.NewMessage(incoming=True, pattern=r"\.sex"))
async def spam(e):
